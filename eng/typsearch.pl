# Searches through the CMU English pronuniation dictionary and counts the number of unique words 
# that have that pattern extracting the type frequency
# The output is just a number. Input is according to pron dict stds incl spaces bettwen phones
use LWP::Simple;
