# Searches through the CMU English pronuniation dictionary and counts the number of occurences 
# of all the words that have that pattern. THe output is a list of all the words, followed by freq for
# each followed by a total for all
use LWP::Simple;
